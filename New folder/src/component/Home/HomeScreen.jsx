...
import image4 from '../../images/Guide.png'
...
function HomeScreen() {
  ...
  useEffect(() => {
    ...
    }, 1000); // Simulate page refresh after 1 second
        ...
        try {
          ...
          axios
            ...
            .then((response) => {
              ...
              if (matchedUser) {
                setUserData({ fullName: matchedUser.name, credits: matchedUser.credits });
              }
            })
      ...
      <div className="card" style={{ background: "none" }}>
        ...
        <div className="card-body">
          <div className="body-div">
            <div className="d-flex">
              <div className="icon">
                <img src={image1} className="market-img" alt="profile" onClick={() => navigate("/profile")}/>
                <h3  onClick={() => navigate("/profile")}>My Profile</h3>
              </div>
              <div className="icon" >
                <img src={image2} className="market-img" alt="team" onClick={() => navigate("/myteam")}/>
                <h3 onClick={() => navigate("/myteam")}>My Team</h3>
              </div>
            </div>
            <div className="d-flex">
              <div className="icon" >
                <img src={image3} className="market-img" alt="Market" onClick={() => navigate("/market")}/>
                <h3 onClick={() => navigate("/market")}>The Market</h3>
              </div>
              <div className="icon" >
                <img src={image4} className="market-img" alt="faq" onClick={() => navigate("/faq")}/>
                <h3 onClick={() => navigate("/faq")}>User Guide</h3>
              </div>
            </div>
          </div>
        </div>
        <div className="card-footer">
          <div className="footer">
            <div className="footer-first">
              <button className="btn3">Start Building Your Team</button>
            </div>
            <div className="d-flex">
              <div className="first">
                <h4>0/8</h4>
